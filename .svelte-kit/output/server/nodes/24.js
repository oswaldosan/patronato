import * as server from '../entries/pages/estadisticas/_page.server.ts.js';

export const index = 24;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/estadisticas/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/estadisticas/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/ProgressBar.bXyYL7lj.css"];
export const fonts = [];
