import * as server from '../entries/pages/movimientos/_page.server.ts.js';

export const index = 25;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/movimientos/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/movimientos/+page.server.ts";
