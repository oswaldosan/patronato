    ...
    <div class="card p-6 bg-slate-50 border-slate-200">
      <div class="flex items-start gap-3">
        ...
        <div class="text-sm text-slate-600">
          ...
          <p class="mt-2">
            Para gestionar proyectos de recaudación (activar, meta, vincular donaciones), ve a
            <a href="/admin/proyectos" class="text-primary-600 hover:underline font-medium">Proyectos</a>.
          </p>
        </div>
      </div>
    </div>
